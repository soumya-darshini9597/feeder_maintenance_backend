...
class Feeder(models.Model):
    ...
    confirmationHeight = models.CharField(max_length=250,help_text="conformationheight in cm ",null=True,blank=True)


    def __str__(self):
        return f"Feeder - mesuredHeight: {self.mesuredHeight} m, stepCount: {self.stepCount},confirmationHeight: {self.confirmationHeight}"
